...
..section .text
 ...
 _start:
     ...
     addi    x7, x7, 10       # Add 10 to low word (0.1 seconds at 100Hz)
 ...
 wait_for_interrupts:
     ...
     # Busy wait with some computation to avoid optimizing out the loop
     li      x6, 50000
 busy_wait:
     addi    x6, x6, -1
     bnez    x6, busy_wait
 ...
 handle_timer_interrupt:
     ...
     addi    t1, t1, 10       # Add 10 to low word (0.1 seconds at 100Hz)
